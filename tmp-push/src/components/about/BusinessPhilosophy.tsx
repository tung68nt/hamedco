...
/**
 * BusinessPhilosophy — Triết lý kinh doanh (redesigned with brand colors)
 */
export default function BusinessPhilosophy() {
  ...
  return (
    <section className="philosophy-section section bg-gray-50">
          ...
          {philosophies.map((item, idx) => (
            ...
            >
              ...
              <div className="philosophy-body">
                <span className="philosophy-keyword">
                  {item.keyword.vi}
                </span>
