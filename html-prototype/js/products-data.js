...
const PHILIPS_PRODUCTS = [
  {
    ...
    description: {
      vi: "Philips Lumify kết hợp đầu dò chất lượng cao, nhẹ và ứng dụng siêu âm trực quan, mang khả năng chẩn đoán đến thiết bị Android tương thích. Thu thập dữ liệu lâm sàng quan trọng nhanh chóng tại điểm chăm sóc: cấp cứu, hồi sức, tại giường bệnh và phòng khám.",
    ...
    images: [
      "assets/images/products/philips-xray.webp",
      "assets/images/products/philips-xray.webp"
    ],
    thumbnail: "assets/images/products/philips-xray.webp",
