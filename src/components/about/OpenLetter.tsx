  ...
  return (
    <section className="open-letter-section section bg-white">
      <div className="container">
        <div className="open-letter-layout">
          {/* Left visual */}
          <div className="open-letter-visual fade-in-up">
            <div className="open-letter-img-wrap">
              <img
                src="/assets/images/about/about-office.webp"
                alt="HAMEDCO Leadership"
                className="open-letter-img"
              />
              <div className="open-letter-img-badge">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                  <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" />
                </svg>
                <div>
                  <strong>Philips</strong>
                  <span>{t("Đối tác phân phối chính thức", "Official distribution partner")}</span>
                </div>
              </div>
            </div>
          </div>
          ...
          {/* Right content */}
          <div className="open-letter-content fade-in-up stagger-1">
            <span className="overline">{t("Thư ngỏ", "Open Letter")}</span>
            <h2>{t("Kính gửi Quý đối tác và Quý khách hàng", "Dear Partners and Customers")}</h2>
            ...
            <div className="open-letter-body">
              ...
              <p>
                {t(
                  "Chúng tôi tự hào là cầu nối đưa công nghệ y tế tiên tiến trên thế giới đến Việt Nam. Việc trở thành Đối tác phân phối chính thức các thiết bị chẩn đoán hình ảnh như hệ thống máy siêu âm, hệ thống chụp CT-scanner, hệ thống chụp cộng hưởng từ (MRI) của Philips Healthcare — tập đoàn công nghệ y tế hàng đầu thế giới, hiện diện tại hơn 100 quốc gia. Sự hợp tác này không chỉ khẳng định vị thế của Hamedco mà còn mang đến cho khách hàng tại Việt Nam cơ hội tiếp cận những công nghệ tiên tiến nhất toàn cầu.",
                  "We are proud to be the bridge bringing advanced medical technology from the world to Vietnam. Becoming the official distribution partner for diagnostic imaging devices — ultrasound systems, CT-scanner, MRI — from Philips Healthcare, the world's leading medical technology group present in over 100 countries. This partnership not only affirms HAMEDCO's position but also brings Vietnamese customers access to the most advanced global technologies."
                )}
              </p>
              <p>
                {t(
            ...
            <div className="open-letter-signature">
              ...
              <p className="signature-text">
                ...
                <br />
                <strong>{t("Ban Lãnh đạo Công ty Hamedco", "HAMEDCO Leadership Board")}</strong>
              </p>
            </div>
          </div>
        </div>
