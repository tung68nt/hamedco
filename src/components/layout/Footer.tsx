        ...
        <div className="container">
          <div className="footer-grid">
            ...
            <div className="footer-brand">
              ...
              <p>{t(
                "Công ty Cổ phần Vật tư và Thiết bị Y tế Hà Nội — Đối tác tin cậy trong lĩnh vực thiết bị y tế từ năm 2005. Nhà phân phối chính thức các hệ thống chẩn đoán hình ảnh của Philips Healthcare tại Việt Nam.",
                "Hanoi Medical Equipment and Supplies Joint Stock Company — A trusted partner in medical equipment since 2005. Official distributor of Philips Healthcare diagnostic imaging systems in Vietnam."
              )}</p>
              ...
              <div className="footer-contact-item">
                <svg width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
                <a href="mailto:info@hamedco.vn" style={{ color: 'inherit' }}>info@hamedco.vn</a>
              </div>
              <div className="footer-contact-item">
                <svg width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeWidth="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" /><path strokeWidth="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
                <div>
                  <span>{t("Hà Nội: Tầng 5 Vimeco, Phạm Hùng", "Hanoi: Fl.5 Vimeco, Pham Hung")}</span>
                  <br />
                  <span>{t("HCM: 436B/22 Đường 3/2, Q.10", "HCM: 436B/22 3/2 St, Dist.10")}</span>
                </div>
              </div>
              <div className="footer-contact-item">
                <svg width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeWidth="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
              ...
              <div className="footer-newsletter">
                <p>{t("Đăng ký nhận tin tức mới nhất", "Subscribe for latest updates")}</p>
                <form className="footer-newsletter-form">
                  <input type="email" placeholder={t("Email của bạn", "Your email")} aria-label="Email" />
            ...
            <div>
              ...
              <div className="footer-links">
                ...
                <Link href="/tin-tuc">{t("Tin tức", "News")}</Link>
            ...
            {/* Policies */}
            <div>
              <h4 className="footer-heading">{t("Chính sách", "Policies")}</h4>
              <div className="footer-links">
                <Link href="/chinh-sach-ban-hang">{t("Chính sách bán hàng", "Sales Policy")}</Link>
                <Link href="/chinh-sach-bao-hanh">{t("Bảo hành & Hậu mãi", "Warranty Policy")}</Link>
                <Link href="/chinh-sach-van-chuyen">{t("Vận chuyển & Lắp đặt", "Shipping Policy")}</Link>
                <Link href="/chinh-sach-doi-tra">{t("Đổi hàng & Hoàn trả", "Return Policy")}</Link>
